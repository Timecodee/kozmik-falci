  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (pickedFile != null) {
        ...
        if (cropped != null) {
          ref.read(faceProvider.notifier).selectImage(cropped);
        }
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    if (state.readingResult != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        ref.read(faceProvider.notifier).clearImage();
    ...
    return Stack(
      children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "(Kırpma penceresinden sadece yüzünüzü odaklayarak seçin)",
                        ...
                        child: state.selectedImage == null
                            ? Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 12),
                                  Text(
                                    "Yüz resmi seçip kırpmak için dokun",
                                    style: GoogleFonts.lora(
                                      color: AppTheme.goldLight.withOpacity(0.5),
                                      fontSize: 14,
                                    ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Zihnini boşalt, çehrendeki anlamı keşfetmek için niyetini buraya yaz...",
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ref.read(faceProvider.notifier).getReading(
                                _intentionController.text,
                              );
                        },
                        child: const Text("ÇEHREMİ ANALİZ ET"),
                      ),
                    ),
                  ],
                ),
        ...
        if (state.isLoading)
          const MysticLoader(
            message: "Yüz hatlarınız inceleniyor, alın yazınız ve çehrenizin kadim anlamı çözülüyor...",
          ),
      ],
    );
  }
